#!/bin/bash
# Test Suite for Snippet: PLANHTML
# Generated: $(date)
# Pattern: \b(PLANHTML|html_plan|html-plan)\b
# Verification Hash: 5b270bf217849c61

set -e

SNIPPET_NAME="PLANHTML"
TEST_KEYWORD="html_plan"
VERIFICATION_HASH="5b270bf217849c61"
TESTS_PASSED=0
TESTS_FAILED=0
...
if [ -z "$snippet_path" ]; then
    snippet_path="snippets/PLANHTML.md"
fi
