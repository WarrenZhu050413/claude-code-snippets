#!/bin/bash
# Test Suite for Snippet: annas-archive
# Generated: $(date)
# Pattern: \b(anna(s|'s)?\s*archive|annasA)\b
# Verification Hash: ced7d096bfb5826d

set -e

SNIPPET_NAME="annas-archive"
TEST_KEYWORD="annas archive"
...
if [ -z "$snippet_path" ]; then
    snippet_path="snippets/annas-archive.md"
fi
