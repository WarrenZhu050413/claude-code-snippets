#!/bin/bash
# Test Suite for Snippet: claude-docs
# Generated: $(date)
# Pattern: \b(claude-?docs?)\b
# Verification Hash: 83a6f9b790a5cb0a

set -e

SNIPPET_NAME="claude-docs"
TEST_KEYWORD="claude-docs"
VERIFICATION_HASH="83a6f9b790a5cb0a"
TESTS_PASSED=0
TESTS_FAILED=0
...
if [ -z "$snippet_path" ]; then
    snippet_path="snippets/claude-docs.md"
fi
