#!/bin/bash
# Test Suite for Snippet: snippet-verify
# Generated: $(date)
# Pattern: \b(snippetV|snippet-verify|verify-snippets?)\b
# Verification Hash: 46747285d35e5fd8

set -e

SNIPPET_NAME="snippet-verify"
TEST_KEYWORD="verify-snippets"
...
if [ -z "$snippet_path" ]; then
    snippet_path="snippets/snippet-verify.md"
fi
