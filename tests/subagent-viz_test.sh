#!/bin/bash
# Test Suite for Snippet: subagent-viz
# Generated: $(date)
# Pattern: \b(subagent|sub-agent|sub\s+agent)s?\b
# Verification Hash: 59f315e92c39e75a

set -e

SNIPPET_NAME="subagent-viz"
TEST_KEYWORD="subagent"
...
if [ -z "$snippet_path" ]; then
    ...
    snippet_path="snippets/subagent-viz.md"
fi
